            ...
            <form id="registerMember" name="registerMember" enctype="multipart/form-data" method="POST" >
                ...
                <span class="login_input login_section">
                    <span class="frm_radio">
                        <span class="radio_box"><input type="radio" id="crew" name="memType" value="임직원" class="radio"> 임직원</span>
                        <span class="radio_box"><input type="radio" id="guest" name="memType" value="게스트" class="radio"> 게스트</span>
                    </span>
                    <span class="login_input">
